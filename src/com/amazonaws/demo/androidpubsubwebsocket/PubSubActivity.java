...
public class PubSubActivity extends Activity {
    ...
    private static final String CUSTOMER_SPECIFIC_ENDPOINT = "a847ch53lmapl.iot.us-east-1.amazonaws.com";

    // Cognito pool ID. For this app, pool needs to be unauthenticated pool with
    // AWS IoT permissions.
    private static final String COGNITO_POOL_ID = "us-east-1:f7cf5862-796b-404f-8b2b-6ddaa6fdf21c";
                                ...
                                runOnUiThread(new Runnable() {
                                    ...
                                    public void run() {
                                        try {
                                            ...
                                            String valorConTexto =  parts[1];
                                            String [] valor = valorConTexto.split(":");

                                            tvLastMessage.setText(valor[1]);
